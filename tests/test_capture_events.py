...
class CaptureEventWriterTests(unittest.TestCase):
    ...
    def test_constructor_has_no_fallible_identity_probe_after_exclusive_open(self) -> None:
        with patch("xpwebapi.capture_output.os.fstat", side_effect=OSError("identity probe failed")):
